...
def run_recbole(
    ...
    test_result = trainer.evaluate(
        test_data, load_best_model=saved, show_progress=config["show_progress"],final=True
    )
    if hasattr(model, 'save_final_embeddings'):
        model.save_final_embeddings()
    ...
    logger.info(set_color("model", "yellow") + f": {config['model']}")  
