...
class Collector(object):
    ...
    def data_collect(self, train_data):
        ...
        if self.register.need("data.item_price"):
            self.item_price = train_data.dataset.item_price  # 确保 item_price 被正确收集
            self.data_struct.set("data.item_price", self.item_price)
        if self.register.need("data.item_time"):
            self.item_time = train_data.dataset.item_time  # 确保 item_price 被正确收集
            self.data_struct.set("data.item_time", self.item_time)
